    ...
    <div class="map-container">
        ...
        <div class="map-detail-card" id="historyDetailCard" hidden>
            ...
            <!-- Advisory-only mock-location warning (see schema.sql's
                 ...
                 blocking, purely for manual review. Hidden by default;
                 assets/js/history.js's showPointDetail() reveals it only
                 when this specific point is flagged. -->
            <span class="badge badge--warning" id="historyDetailMockBadge" hidden>Possible Mock GPS</span>
