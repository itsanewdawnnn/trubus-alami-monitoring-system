...
/**
 * Turns raw GPS coordinates into a short "Dekat X, Jalan Y" label using
...
object ReverseGeocodingService {
     ...
     * prefixes "Dekat " for a short landmark hint instead of the full address.
     */
